...
cd Fdk2R
"%MsBuildFilePath%" RFdk.sln /target:Rebuild /p:Platform=x86 /p:Configuration=Release /maxcpucount /fl /flp:Verbosity=Normal;LogFile=Log /clp:NoItemAndPropertyList /verbosity:n /nologo
cd ..
